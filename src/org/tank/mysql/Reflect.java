 ...
 * can be made.
 * <p>
 * An example of using <code>org.tank.mysql.util.Reflect</code> is <code><pre>
 * // Static import all reflection methods to decrease verbosity
 * import static org.joor.org.tank.mysql.util.Reflect.*;
 * <p>
...
public class Reflect {
	...
	private Method similarMethod(String name, Class<?>[] types) throws NoSuchMethodException {
		...
		throw new NoSuchMethodException("No similar method "
		                                + name
		                                + " with params "
	...
	private boolean isSimilarSignature(Method possiblyMatchingMethod,
		...
		return possiblyMatchingMethod.getName().equals(desiredMethodName) && match(
				possiblyMatchingMethod.getParameterTypes(),
				desiredParamTypes);
	}
